...
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (1, 'Articles', 'articles.cfm', 'left', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (2, 'Articles Archive', 'articles_archives.cfm', 'left', '1','1')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (3, 'Current Blog Posts', 'blog_posts.cfm', 'left', '1','3')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (4, 'Did You Know...', 'dyk.cfm', 'left', '1','4')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (5, 'Newsletter Subscription', 'newsletters.cfm', 'left', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (6, 'Site Pages', 'pages_menu.cfm', 'right', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (7, 'Available Sections', 'site_modules.cfm', 'right', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (8, 'Site Search', 'site_search.cfm', 'right', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (9, 'Stock Quotes', 'stock_quotes.cfm', 'right', '1','0')
INSERT webos_config_sidebox (side_box_id, side_box_name, side_box_filename, side_box_column, side_box_active, side_box_position) VALUES (10, 'User Profile', 'user_login.cfm', 'right', '1','0')
...
INSERT webos_config (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group, weight, last_modified) VALUES (7, 'Site Location', 'site_location', '#form.site_location#', 'The Path on Server of the WebOS Installation', 'CORE', 5, NULL)
...
INSERT webos_config (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group, weight, last_modified) VALUES (42, 'Enable Dynamic Page Titles on Webiste', 'show_page_titles', '1', 'Enables display of Page Titles in your Browser', 'CORE', 0, NULL)
