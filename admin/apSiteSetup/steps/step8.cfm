...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="3">Now that we've set up your datasource, created your database and populated it with some information, we're going to create the Profile for a user to log in to his or her new website to adminster. This is a SingleUser account, for a single site, that you're creating.<br />
      <br />
      Fill out the information below to create and insert your SingleUser Profile:</td>
    </tr>
  <tr>
