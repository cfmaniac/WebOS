...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
       ...
       insert into webos_admins (username, password, name, permissions, SiteID) values ('#form.username#', '#form.password#', '#form.name#', '1', '#session.newSiteID#')
       </cfquery>
                </p>
              <p>We have successfully created your SingleUser Account!<br />
